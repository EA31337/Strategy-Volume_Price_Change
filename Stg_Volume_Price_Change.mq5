...
/**
 * @file
 * Strategy based on the Volume Price Change oscillator (Volume Price Change).
 */

// Includes.
#include <EA31337-classes/EA.mqh>

#include "Indi_Volume_Price_Change.mqh"
...
// Includes strategy.
#include "Stg_Volume_Price_Change.mqh"

// Defines.
#define ea_name "Stg_Volume_Price_Change"
#define ea_version "1.000"
#define ea_desc "Multi-strategy advanced trading robot"
#define ea_link "https://github.com/EA31337/Strategy-Volume_Price_Change"
...
int OnInit() {
  ...
  ea = new EA(ea_params);
  _result &= ea.StrategyAdd<Stg_Volume_Price_Change>(Active_Tfs);
