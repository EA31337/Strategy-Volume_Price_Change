...
struct Stg_Volume_Price_Change_EURUSD_M15_Params : Stg_Volume_Price_Change_Params {
  Stg_Volume_Price_Change_EURUSD_M15_Params() {
    ...
    Volume_Price_Change_MaxSpread = 4;
  }
} stg_vpc_arrays_m15;
