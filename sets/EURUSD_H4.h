...
struct Stg_Volume_Price_Change_EURUSD_H4_Params : Stg_Volume_Price_Change_Params {
  Stg_Volume_Price_Change_EURUSD_H4_Params() {
    ...
    Volume_Price_Change_MaxSpread = 10;
  }
} stg_vpc_arrays_h4;
